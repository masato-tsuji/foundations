...
const {
  ...
  function Quiz1() {
    const [value, setValue] = React.useState("Monaco");
    ...
    function QuizReaction() {
      if (value == "Vatican" && buttonPushStatus) {
        return (
          <Box mt={1}>
            <Paper className={classes.reaction_success}>That's right</Paper>
          </Box>
        );
      } else if (buttonPushStatus) {
        return (
          <Box mt={1}>
            <Paper className={classes.reaction_error}>That's wrong</Paper>
          </Box>
        );
      } else {
        return <Paper></Paper>;
    ...
    return (
      <FormControl class="quiz" component="fieldset">
        <FormLabel component="legend" className={classes.quiz_label}>
        ...
        <br />
        <Button variant="contained" color="primary" onClick={quizButton}>
          Answer
        </Button>
        <QuizReaction />
      </FormControl>
